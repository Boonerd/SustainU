    ...
    <section className="pt-32 pb-24 px-6 text-center bg-gradient-to-b from-cream to-white dark:from-darkbg dark:to-darkcard">
      ...
      <div className="flex flex-col sm:flex-row gap-6 justify-center">
        <button
          ...
          className="px-10 py-5 bg-deepgreen dark:bg-midgreen text-white text-lg font-bold rounded-full hover:scale-105 transition flex items-center gap-3 shadow-lg"
        >
          Start Your Journey <ArrowRight className="w-6 h-6" />
        </button>
        <button
          onClick={() => goToPage("voices")}
          className="px-10 py-5 border-2 border-deepgreen dark:border-lightgreen text-deepgreen dark:text-lightgreen font-bold rounded-full hover:bg-deepgreen/10 dark:hover:bg-midgreen/20 transition"
        >
          Explore Stories
        </button>
      </div>
